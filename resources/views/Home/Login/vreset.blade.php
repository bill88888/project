...
<section style="margin-left: 200px">
        ...
        <div class="pc-step-title fl">
            <ul>
                ...
                <li class="cur"><a href="javascript:void(0)">2 . 重置密码</a></li>
                <li><a href="javascript:void(0)">3 . 完成</a></li>
            </ul>
        </div>
    </div>
</section>
 ...
 <div class="login-back" style="height:150px;margin-left: 150px;margin-top: 100px">
                <form action="/doreset" method="post">
                    ...
                    <div class="login-input">
                        <label><i class="heart">*</i>密码：</label>
                        <input type="password" class="list-input1" name="password" placeholder="请输入可用邮箱" reminder="请输入正确的手机号">
                    </div>
                    <div class="login-input">
                        <label><i class="heart">*</i>确认密码：</label>
                        <input type="password" class="list-input1" name="repassword" placeholder="请输入可用邮箱" reminder="请输入正确的手机号">
                    </div>
                    
                    <div class="login-button">
                        {{csrf_field()}}
                        <input type="hidden" name="id" value="{{$id}}">
                       <input type="submit" value="点击获取邮箱验证码" style="background-color:#ea4949; width:200px; height:50px; font-size: 15px; color:white; cursor:pointer; border: #ea4949">
                    </div>
                </form>
        </div>
