...
<head>
	...
	<title>立即登录</title>
    <link rel="stylesheet" href="/homeStatic/css/base.css">
    <link rel="stylesheet" type="text/css" href="/homeStatic/css/login.css">
    <script src="/homeStatic/js/jquery-3.1.1.min.js"></script>
</head>
<body>
<div class="w">
	<div id="logo">
		<a href="index.html">
			<img src="/homeStatic/icon/logo.png" alt="">
		</a>
		<b></b>
	</div>
  ...
  <div class="login-wrap">
  	<div class="w">
  		<div class="login-form">
            ...
            @endif
  			  	<div class="form">
  			  		<form action="/homelogin" id="formlogin" method="post">
  			  			<div class="item item-fore1 item-error">
  			  				<label for="loginname" class="login-label name-label"></label>
  			  				<input type="text" name="email" id="loginname" class="itxt" tabindex="1" autocomplete="off" placeholder="邮箱">
                        ...
                        <div class="item item-fore5">
                        	<div class="login-btn">
                            {{csrf_field()}}
                        		 <input type="submit" value="登录" style="background-color:#ea4949; width:200px; height:50px; font-size: 15px; color:white; cursor:pointer; border: #ea4949; margin-left: 50px">
                        	</div>
                        </div>
  			  		</form>
  			  	</div>
  				...
  				<div class="mc">
  					...
  					<div class="qrcode-main">
  						...
  						<div class="qrcode-img" style="">
  							<img src="/homeStatic/login/code.png" alt="">
  				...
  				<ul>
  					<li class="extra-r">
  					   <div class="regist-link">
  						<a href="/emailregister/create" class="">
  							<b></b>立即注册
  						</a>
  					   </div>
  					</li>
  	...
  	<div class="login-banner" style="background-color: #ea4949">
  		<div class="w">
  			<div id="banner-bg" class="i-inner" style="background: url(/homeStatic/login/a1.jpg);"></div>
  		</div>
  	</div>
  </div>
</div>
