    ...
    <div class="container clearfix">
        ...
        <div class="head-form fl">
            <form class="clearfix" action="/fenso" method="post">
                ...
                {{csrf_field()}} 
                <button class="button" onClick="">搜索</button>
            </form>
        ...
        <div class="yNavIndex">
            ...
            <ul class="pullDownList">
                ...
                <li class="menulihover">
                    <i class="listi1"></i>
                    <a href="all-cl.html" target="_blank">{{$row->name}}</a>
                    <span></span>
                </li>
                @endforeach
            </ul>
                ...
                <div class="yMenuListConin">
                    <div class="yMenuLCinLisi fl">
                        <ul>
                            ...
                            <li><a href="#">{{$row1->name}}<i class="fr"></i></a></li>
                            @endforeach
                        </ul>
                     </div>
...
<section id="pc-banner">
    <div class="yBanner">
        <div class="banner" id="banner" >
            @foreach($data as $row)
            <a href="javascript:;" class="d1" style="background:url({{$row->pic}}) center no-repeat;background-color: #f01a38; padding-left:180px;background-size:100% 480px"></a>
            @endforeach
...
<section id="pc-advert">
    <div class="container-c clearfix">
        <a href="page.html" target="_blank"><img src="/homeStatic/img/pd/pd1.png"></a>
        <a href="page.html" target="_blank"><img src="/homeStatic/img/pd/pd2.png"></a>
        <a href="page.html" target="_blank"><img src="/homeStatic/img/pd/pd3.png"></a>
        <a href="page.html" target="_blank"><img src="/homeStatic/img/pd/pd4.png"></a>
    </div>
</section>
<!-- advert End -->
...
<div class="time-lists clearfix">
                        ...
                        <ul>
                            <li>
                                <a href="page.html" target="_blank">
                                    <img src="/homeStatic/img/pd/p1.png">
                            ...
                            <li>
                                <a href="page.html" target="_blank">
                                    <img src="/homeStatic/img/pd/p2.png">
                                    <p class="head-name">TP-LINK TL-WN725N 微型150M无线USB网卡</p>
                                    <p><span class="price">￥138.00</span><span class="discount">￥1000</span></p>
                                    <p class="label-default">3.45折</p>
                                </a>
                            ...
                            <li>
                                <a href="page.html" target="_blank">
                                    <img src="/homeStatic/img/pd/p3.png">
                                    <p class="head-name">TP-LINK TL-WN725N 微型150M无线USB网卡</p>
                                    <p><span class="price">￥138.00</span><span class="discount">￥1000</span></p>
                                    <p class="label-default">3.45折</p>
                                </a>
                            ...
                            <li>
                                <a href="page.html" target="_blank">
                                    <img src="/homeStatic/img/pd/p4.png">
                                    <p class="head-name">TP-LINK TL-WN725N 微型150M无线USB网卡</p>
                                    <p><span class="price">￥138.00</span><span class="discount">￥1000</span></p>
                                    <p class="label-default">3.45折</p>
                                </a>
    ...
    <div class="news-list fr">
        ...
        <div class="time-border" style="border-left:none;">
            ...
            <div class="time-poduse"><img src="/homeStatic/img/pd/pj1.png"></div>
        </div>
    </div>
</div>
<!-- 限时抢购 End -->
...
<div class="container-c time-lists clearfix">
    <div class="time-list fl">
        ...
        <div class="time-poued clearfix">
            <a href="#"><img src="/homeStatic/img/ad/a2.png"></a>
            <a href="#"><img src="/homeStatic/img/ad/a3.png"></a>
            <a href="#"><img src="/homeStatic/img/ad/a4.png"></a>
            <a href="#"><img src="/homeStatic/img/ad/a5.png"></a>
        </div>
    </div>
    <div class="news-list fr">
        <div class="time-title time-clear"><h2>今日值得购买</h2></div>
        <div class="news-right"><a href="#"><img src="/homeStatic/img/ad/a1.png"></a></div>
    </div>
</div>
<!-- 卖场推荐 End -->
                ...
                <div class="yScrollListIn">
                    <div style="display:block;" class="yScrollListInList yScrollListInList1">
                        <ul>
                            ...
                            <li>
                                <a href="">
                                    <img src="/homeStatic/img/pd/p5.png">
                                    <p class="head-name pc-pa10">TP-LINK TL-WN725N 微型150M无线USB网卡</p>
                                    <p class="label-default">3.45折</p>
                                </a>
                            </li>
                            <li>
                                <a href="">
                                    <img src="/homeStatic/img/pd/p6.png">
                                    <p class="head-name pc-pa10">TP-LINK TL-WN725N 微型150M无线USB网卡</p>
                                    <p class="label-default">3.45折</p>
                                </a>
                            </li>
...
<div class="containers main-banner"><a href="#"><img src="/homeStatic/img/ad/br1.jpg" width="1200" height="105"></a> </div>

<div class="time-lists  clearfix">
    @foreach($res as $row)
    <div class="time-list time-list-w f1">
        <div class="time-title time-clear-f"><h2>{{$row->name}}</h2>
            <ul class="brand-tab H-table clearfix fr" id="H-table">
                @foreach($row->suv as $rows)
                <li><a href="javascript:void(0);" class="cur">{{$rows->name}}</a></li>
                @endforeach
            </ul>
        </div>
        <div class="time-border time-border-h clearfix">
            <div class="brand-img fl">
                <ul>
                    <li><a href="#"><img src="/homeStatic/img/ad/p1.png" width="125" height="47"></a></li>
                    <li><a href="#"><img src="/homeStatic/img/ad/p2.png" width="125" height="47"></a></li>
                    <li><a href="#"><img src="/homeStatic/img/ad/p3.png" width="125" height="47"></a></li>
                    <li><a href="#"><img src="/homeStatic/img/ad/p4.png" width="125" height="47"></a></li>
                    <li><a href="#"><img src="/homeStatic/img/ad/p5.png" width="125" height="47"></a></li>
                    <li><a href="#"><img src="/homeStatic/img/ad/p6.png" width="125" height="47"></a></li>
                </ul>
            </div>
            <div class="brand-bar fl"><a href="#"><img src="/homeStatic/img/ad/bar.jpg" width="300" height="476"></a> </div>
            <div class="brand-poa fl">
         
              @foreach($row->suv as $ocate)
              
                <div class="brand-poa H-over clearfix" id="div"> 
                    <ul>
                      @foreach($shop as $s)
                      @foreach($s as $v)
                        @if($v->cid == $ocate->id)
                        <li>
                            <div class="brand-imgss">
                                <a href="/index/{{$v->sid}}"><img src="{{$v->pic}}" height="165px" width="220px"></a>
                            </div>
                            <div class="brand-price">{{$v->name}}</div>
                            <div class="brand-title"><a href="#">{!!$v->descr!!}</a></div>
                            <div class="brand-price">{{$v->price}}</div>
                        </li>
                        @endif
                       @endforeach
                       @endforeach
...
<div class="time-lists clearfix">
    <div class="time-list fl">
        ...
        <div class="time-border time-border-h clearfix">
            <div class="fl shop-img">
                <div class="shop-title"><a href="#"><img src="/homeStatic/img/ad/shop1.png"></a></div>
                <div class="shop-text"><h2>熊太子坚果炒货金冠店铺...</h2> <p>[正品 有赠品 如实描述]</p></div>
                <div class="shop-work clearfix"><a href="#"><img src="/homeStatic/img/ad/shop2.png"></a><a href="#"><img src="/homeStatic/img/ad/shop3.png"></a> </div>
            </div>
            <div class="shop-bar clearfix fl">
                <ul>
                    <li>
                        <div class="shop-icn"><a href="#"><img src="/homeStatic/img/ad/shop4.png"></a></div>
    ...
    <div class="news-list fr">
        ...
        <div style="border-left:none;" class="time-border time-border-h">
            <ul class="shop-top">
                <li class="clearfix">
                    <div class="shop-name fl"><a href="#"><img src="/homeStatic/img/ad/top1.png"></a></div>
        ...
        <div class="time-list time-list-w fl">
            ...
            <div class="time-border time-border-h clearfix">
                <div class="fl shop-img">
                    ...
                    <div class="shop-re"><a href="#"><img src="/homeStatic/img/ad/shop5.png"></a> </div>
                </div>
                <div class="shop-bar shop-bar-w clearfix fl">
                    ...
                    <div class="clearfix" style="width:980px;">
                        <div class="shop-fl fl">
                            <div class="shop-work clearfix"><a href="#"><img src="/homeStatic/img/ad/shop2.png"></a><a href="#"><img src="/homeStatic/img/ad/shop3.png"></a> </div>
                            <div class="clearfix"><div class="shop-name fl"><a href="#"><img src="/homeStatic/icon/shop-user.png"></a></div><div class=" fl"><p>搜悦用户</p> <p>2015-5-24 <em>11:25</em></p> </div></div>
