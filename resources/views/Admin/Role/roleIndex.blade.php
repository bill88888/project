 ...
 <body>
  <div class="mws-panel grid_8"> 
   <div class="mws-panel-header"> 
    <span><i class="icon-table"></i>管理角色列表</span> 
   </div> 
     ...
     <table class="mws-datatable mws-table dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 193px;">管理角色名</th>
      ...
      @foreach($role as $row)
       <tr class="odd"> 
        ...
        @if($row->id==1)  
        <td>
             <a class="btn btn-success" href="/adminroleauth/{{$row->id}}">分配权限</a>
        </td> 
        @else
        <td>
