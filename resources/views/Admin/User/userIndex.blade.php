     ...
     <table class="mws-datatable mws-table dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 193px;">管理员名</th>
       ...
       <tr class="odd"> 
        ...
        <td>
           <form action="/adminuser/{{$row->id}}" method="post">
            ...
            <a class="btn btn-info" href="/adminuser/{{$row->id}}/edit">修改</a>
            <a class="btn btn-success" href="/adminuserrole/{{$row->id}}">分配角色</a>
           </form>
